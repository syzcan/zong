...
<form id="form" method="post" action="${ctx }/login.json" style="margin:100px auto;width: 400px">
	<div class="easyui-panel" title="欢迎使用${zparam.WEB_NAME['param_value'] }" style="width:100%;width:400px;padding:30px 60px;text-align: center;">
		<div style="margin-bottom:20px">
			<input id="username" name="username" class="easyui-textbox" data-options="required:true,iconCls:'fa fa-user',label:'账号:',labelPosition:'top'" style="width:100%;height:52px">
		</div>
		<div style="margin-bottom:20px">
			<input id="password" name="password" class="easyui-textbox" data-options="required:true,iconCls:'fa fa-key',label:'密码:',labelPosition:'top'" style="width:100%;height:52px" type="password">
		</div>
		
		<div style="margin-bottom:20px">
			<a onclick="$('#form').submit()" class="easyui-linkbutton" data-options="iconCls:'fa fa-check text-green'" style="width:100%;height:32px">登录</a>
		</div>
